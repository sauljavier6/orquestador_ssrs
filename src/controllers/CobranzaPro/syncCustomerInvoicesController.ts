    ...
    try {
        ...
        while (hasMore) {
            ...
            SELECT TOP ${batchSize}
                ...
                t.tranid,
                t.entity,
                --t.custbody_cliente_original, -- descomentar cuando se libere en produccion
                t.trandate,
                t.duedate,
                t.foreigntotal,
                t.foreignamountpaid,
            ...
            AND t.voided = 'F'
            AND t.custbody_nso_ct_metodo_pago = '10' 
            --AND t.entity NOT IN (8382, 1234, 5678)
            AND (
        ...
        `;
            ...
            resultadostest.push(...cleanResult);
